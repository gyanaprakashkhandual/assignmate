...
// Fix: Use `type` aliases with Omit that also drops conflicting `onChange` and `value`
// from the base DateTimeProviderProps, then re-declare them with the correct string signatures.
// `interface extends` cannot narrow inherited property types — `type &` must be used instead.
...
export type StandaloneDatePickerProps = Omit<
  DateTimeProviderProps,
  "children" | "onChange" | "value"
> & {
  size?: PickerSize;
...
export type StandaloneTimePickerProps = Omit<
  DateTimeProviderProps,
  "children" | "onChange" | "value"
> & {
  size?: PickerSize;
