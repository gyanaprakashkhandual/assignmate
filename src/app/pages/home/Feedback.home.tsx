      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-zinc-500 dark:text-zinc-400 max-w-xl mx-auto" style={{ fontFamily: "'Lora', serif" }}>
            From students to professionals — here is what people are saying about Assignmate.
          </p>
        </motion.div>
        ...
        <div ref={ref} className="columns-1 sm:columns-2 lg:columns-3 gap-5 space-y-5">
          {testimonials.map((t, i) => (
            ...
            >
              ...
              <p className="text-sm text-zinc-700 dark:text-zinc-300 leading-relaxed mb-5" style={{ fontFamily: "'Lora', serif" }}>
                "{t.text}"
              </p>
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-full bg-zinc-200 dark:bg-zinc-700 flex items-center justify-center text-xs font-bold text-zinc-600 dark:text-zinc-300 flex-shrink-0">
                  {t.avatar}
                </div>
                <div>
