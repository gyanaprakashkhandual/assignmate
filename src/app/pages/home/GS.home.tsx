...
export default function GettingStarted() {
  ...
  return (
    <section id="how-to-use" className="py-24 lg:py-32 bg-white dark:bg-zinc-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div ref={ref} className="relative">
          <div className="hidden lg:block absolute top-16 left-1/2 -translate-x-1/2 w-[calc(66%-4rem)] h-px bg-gradient-to-r from-transparent via-zinc-300 dark:via-zinc-700 to-transparent" />
            ...
            {steps.map((step, i) => (
              ...
              >
                <div className="relative mb-8">
                  ...
                  <span
                    className="absolute -top-3 -right-3 text-xs font-black text-zinc-300 dark:text-zinc-700 select-none"
                ...
                <p className="text-base text-zinc-500 dark:text-zinc-400 leading-relaxed" style={{ fontFamily: "'Lora', serif" }}>
                  {step.description}
                </p>
              </motion.div>
            ))}
