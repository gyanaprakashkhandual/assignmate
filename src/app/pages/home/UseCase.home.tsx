          ...
          {useCases.map((uc, i) => (
            ...
            >
              ...
              <div className="relative">
                ...
                <h3 className="text-2xl font-bold text-zinc-900 dark:text-white mb-3 leading-snug">
                  {uc.title}
                </h3>
                <p
                ...
                <div className="flex items-start gap-2">
                  <span className="mt-1 w-3 h-px bg-zinc-400 dark:bg-zinc-600 shrink-0 inline-block" />
                  <p
                    className="text-sm font-medium text-zinc-600 dark:text-zinc-300 italic"
                    style={{ fontFamily: "'Lora', serif" }}
                  >
                    {uc.highlight}
                  </p>
