      ...
      <div className="flex min-w-0 items-center gap-2">
        {isLoading && !currentSessionTitle ? (
          <div className="flex items-center gap-1.5">
            <Loader2 size={11} className="animate-spin text-black/25 dark:text-white/25" />
            <span className="text-xs text-black/30 dark:text-white/30">Loading…</span>
          </div>
        ) : (
          <div className="flex min-w-0 items-center gap-1.5">
            ...
            {isArchived && (
              <span className="flex-shrink-0 rounded border border-black/10 px-1 py-px text-[9px] font-medium text-black/35 dark:border-white/10 dark:text-white/35">
                Archived
              </span>
            )}
          </div>
          ...
          <button
            ...
            className={`flex h-7 w-7 items-center justify-center rounded-lg transition-colors xl:hidden ${
              previewOpen
                ...
                : "text-black/30 hover:bg-black/[0.06] hover:text-black dark:text-white/30 dark:hover:bg-white/[0.07] dark:hover:text-white"
            }`}
          >
