...
export const selectProfileFetched = createSelector(selectProfileState, (p) => p.isFetched);
...
export const selectHandwritingImage = createSelector(selectProfile, (profile) => profile?.handwritingImage ?? null);
export const selectHasHandwritingImage = createSelector(selectProfile, (profile) => !!profile?.handwritingImage);
