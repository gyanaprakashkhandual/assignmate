...
import { Plus, Trash2, Archive, ShieldAlert, MoreHorizontal } from "lucide-react";
import { ActionMenu, DefaultTrigger, type ActionItem } from "@/components/ui/Action.menu";
import { HistorySearchBar } from "./HistorySearchBar";
import { HistoryFilterMenu } from "./HistoryFilterMenu";
import { HistoryFilterState, BulkAction } from "../types/history.types";
                ...
                >
                    ...
                    >
                        ...
                        {isIndeterminate && !isAllSelected && (
                            <svg width="9" height="9" viewBox="0 0 9 9" fill="none">
                                <path d="M2 4.5H7" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
                            </svg>
                        )}
                    </div>
                </div>
