    ...
    return (
        ...
        >
            ...
            <div className="rounded-xl border border-red-200 overflow-hidden">
                <div className="px-5 py-4 bg-white flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        ...
                        <div className="rounded-xl border border-red-200 bg-red-50 p-5 space-y-4">
                            <div className="flex items-start gap-3">
                                ...
                                <div className="space-y-1">
                                    <p className="text-sm font-semibold text-red-700">This will permanently delete:</p>
                                    <ul className="space-y-1">
                                        {["Your profile and username", "Your handwriting sample", "All assignments and history"].map((item) => (
                            ...
                            <div className="space-y-2">
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-2.5 rounded-lg border border-red-200 bg-white text-sm text-black focus:outline-none focus:ring-2 focus:ring-red-400 focus:border-transparent placeholder-red-300"
                                />
                            </div>
