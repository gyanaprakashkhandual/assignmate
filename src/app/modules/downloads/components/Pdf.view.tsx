              ...
              <div className="flex items-center gap-3 px-5 py-3.5 border-b border-gray-100 dark:border-gray-900 shrink-0">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 mt-0.5">
                    ...
                    <span className="text-gray-200 dark:text-gray-800">·</span>
                    <span
                      className={`text-[11px] font-medium flex items-center gap-0.5 ${pdf.exportedBy === "auto" ? "text-blue-500 dark:text-blue-400" : "text-gray-500 dark:text-gray-500"}`}
                    >
                      {pdf.exportedBy === "auto" ? (
                        <Zap size={9} />
                      ) : (
