...
import { ActionMenu, IconTrigger, type ActionItem } from "@/ui/navigations/action/Action.menu.ui";
...
export function PdfListRow({ pdf, index, onView, onDownload, onShare, onDelete, onOpenChat }: PdfListRowProps) {
    ...
    return (
        ...
        >
            ...
            <div className="flex-1 min-w-0 cursor-pointer" onClick={() => onView(pdf)}>
            ...
            <div className="shrink-0 flex items-center gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity duration-150">
                ...
                <div onClick={(e) => e.stopPropagation()}>
                    <ActionMenu
                        ...
                        align="bottom-right"
                        size="sm"
                        trigger={<IconTrigger size="sm" icon={<MoreHorizontal size={13} />} variant="ghost" />}
                    />
                </div>
            </div>
        </motion.div>
