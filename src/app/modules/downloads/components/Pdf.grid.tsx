"use client";
import { useRef, useEffect, useCallback } from "framer-motion";
import { AnimatePresence } from "framer-motion";
import { Loader2 } from "lucide-react";
import { IPdfRecord } from "@/lib/types/chat.types";
import { PdfViewMode } from "../types/pdf.types";
import { PdfCard } from "./PdfCard";
import { PdfListRow } from "./PdfListRow";
        ...
        <div>
            ...
            {isFetchingMore && (
                <div className="flex justify-center py-6">
                    <Loader2 size={16} className="animate-spin text-gray-400 dark:text-gray-600" />
                </div>
            )}
        </div>
    );
